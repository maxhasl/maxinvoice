  ...
  return (
    <div className="App">
      ...
      <input
        ...
        accept="image/*"
      ></input>
      <img className={cl.testImg} alt="logo" src={image} />
    </div>
  );
};
